...
public final class RJT_Utils implements Constants{
...
//**********************************************************************************************************************
    ...
    public static final void cycle(int n0[], int n1[], int n2[]){
        int temp = n2[0];
        n2[0] = n1[0];
        n1[0] = n0[0];
        n0[0] = temp;
    ...
    public static final void cycle(int n0[], int n1[], int n2[], int n3[]){
        int temp = n3[0];
        n3[0] = n2[0];
        n2[0] = n1[0];
        n1[0] = n0[0];
